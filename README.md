...
A secure password generator with strength-based logic and evaluation.

🔹 Features:

Generates passwords based on selected strength (weak, medium, strong)
Ensures character variety (lowercase, uppercase, digits, symbols)
...
A system that processes and evaluates student academic performance.

🔹 Features:

Stores subject marks using dictionaries
